...
class NoticeUpdatePage extends GetView<NoticeController> {
  Function refresh;
  NoticeRecord noticeRecord;
  NoticeUpdatePage({super.key, required this.refresh,required this.noticeRecord}){
    controller.setFormValue(noticeRecord: noticeRecord);
  }
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    _buildChooseFileTextFormField(
                      controller: controller.chooseFile,
                      label: "Choose File",
                      onTap: controller.onChooseFileTap,
                    ),
                    _buildTextFormField(
                        vfn: controller.emptyValidation,
                    ...
                    ElevatedButton(
                      onPressed: () {
                        controller.onUpdate(fn: refresh,noticeId: noticeRecord.noticeID!);
                      },
