...
class OnlineClsAddPage extends GetView<OnlineClsController> {



  OnlineClsAddPage({super.key});

  @override
  Widget build(BuildContext context) {
    var controller=Get.put(OnlineClsController());
    return Scaffold(
      appBar: AppBar(
        leading: BackButton(
