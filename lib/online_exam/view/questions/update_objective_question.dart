...
class UpdateObjectiveQuestion extends GetView<PaperController> {
  UpdateObjectiveQuestion({Key? key,}) : super(key: key);
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        TextFormField(
                          textInputAction: TextInputAction.next,
                          onFieldSubmitted: (value) => FocusScope.of(context).requestFocus(controller.focus2),
                    ...
                    child: Column(
                      children: [
                        TextFormField(
                          ...
                          onFieldSubmitted: (value) => FocusScope.of(context).requestFocus(controller.focus3),
                    ...
                    child: Column(
                      children: [
                        TextFormField(
                          ...
                          onFieldSubmitted: (value) => FocusScope.of(context).requestFocus(controller.focus4),
