...
import 'add_objective_question.dart';
import 'list_item_objective.dart';

class ListQuestionObjective extends GetView<PaperController> {
...
*/
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder(
                  stream: controller.mdqPaperModel.stream,
                  builder: (BuildContext context, snapshot) {
                    if (snapshot.data != null) {
                      ...
                      Get.log(snapshot.data?.records?.first.question ?? "");
                      Get.log(snapshot.data?.records?.first.questionID ?? "");
                      return Column(
                        children: [
                          ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return Padding(
                                  ...
                                  child: ListItemObjective(
                                      f: () => {},
                                      records: snapshot.data!.records![index],
                                      size: snapshot.data!.records!.length));
                            },
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          var res = await Get.to(AddObjectiveQuestion());
          // if (res != null) {
          //   examService.getQuestions("Obj", examID: widget.examRecord.examID!,clsId: widget.clsId,subId: widget.examRecord.subjectID!);
          // }
        },
                ...
                children: [
                  ...
                  TextButton(
                      onPressed: () {
                        ...
                        // sylController.downloadSyllabusFiles("http://latestapp.decorainfotech.in/Document/Sample_Obj_Question.xlsx");
                        // EasyLoading.dismiss();
                      },
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () {
                          // examService.uploadmcqSheet(type: "Obj",examId: widget.examRecord.examID!, subId: widget.examRecord.subjectID!, clsId: widget.clsId, bytes: base64Str);
                          // Get.back();
                          // base64Str="";
                          // fileName.text="";
                        },
