...
class ExamAddPage extends GetView<ExamController> {

  ExamAddPage({super.key});
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Obx(() => Radio<bool>(
                                  value: true,
                                  groupValue: controller.isResult.value,
                                  onChanged: (value) {
                                    controller.isResult.value = value!;
                                  },
                                )),
                            // SizedBox(width: 5.0),
                            const Text("True"),
