...
class SbrAbout extends StatelessWidget {
  const SbrAbout({Key? key}) : super(key: key);
...
*/
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Ams().imageWidget(ImageAssets.sbr_logo, height: 100.h, width: 174.w),
            SizedBox(
              height: 26.h,
            ),
            Text(
            ...
            const Spacer(),
            Ams().imageWidget(ImageAssets.sbr_logo, height: 97.h, width: 76.w),
            Text(
              "SBR Cloud Services Pvt Ltd",
              style:
