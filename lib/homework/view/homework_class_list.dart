...
class HomeWorkClassList extends GetView<HomeWorkController> {
  const HomeWorkClassList({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<HomeWorkModel>(
        stream: controller.homeWorkClassList.stream,
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Card(
                    child: ListTile(
                      onTap: () {
                        controller.onHomeWorkClassClick(data.records?[index].classID??"");
                      },
