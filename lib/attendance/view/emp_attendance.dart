...
import 'package:decora_admin/attendance/view/periods.dart';
...
class EmpAttendance extends GetView<AttendanceController> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
                ...
                children: [
                  SizedBox(
                      ...
                      child: BuildDateTextFormField(
                          ...
                          label: "Select Date",
                          callBack: controller.empDateCallBack)),
                  SizedBox(
                      width: MediaQuery.of(context).size.width / 2 - 20,
            ...
            StreamBuilder(
              stream: controller.empAttendanceModel.stream,
              builder: (context, snapshot) {
                if (snapshot.data == null ||
                  ...
                  return SizedBox(
                      height: 100.h,
                      child:
                          Center(child: Text("Please select class and Date")));
                }
