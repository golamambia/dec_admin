...
class ActivityUpdatePage extends GetView<ActivityController> {
  Function refresh;
  ActivityRecord activityRecord;
  ActivityUpdatePage({super.key, required this.refresh,required this.activityRecord}){
    controller.setFormValue(activityRecord: activityRecord);
  }
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        controller.onUpdate(fn: refresh,activityId: activityRecord.activityID!);
                      },
